    ...
    <div className="flex h-full w-full">
      <div className="bg-speedauto-sidebar flex flex-col justify-center items-center h-screen w-screen">
        ...
        <div className="bg-white rounded-lg shadow-lg p-10 flex flex-col justify-center items-center w-full max-w-md">
          ...
          <p className="font-poppins text-1xl mb-4">
            Cadastrar novo usuário do sistema
          </p>

          <form
            onSubmit={handleSubmit}
            className="flex flex-col mt-3 w-full h-full"
          >
            <label htmlFor="nome" className="mb-1 mt-3 font-semibold">
              Nome
            </label>
            <input
              type="nome"
            ...
            <label htmlFor="telefone" className="mb-1 mt-3 font-semibold">
              Telefone
            </label>
            <input
              type="telefone"
            ...
            <label htmlFor="email" className="mb-1 mt-3 font-semibold">
              Email
            </label>
            <input
              type="email"
            ...
            <label htmlFor="password" className="mb-1 mt-3 font-semibold">
              Senha
            </label>
            <input
              type="password"
