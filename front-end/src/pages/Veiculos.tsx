...
import { FaPlus, FaEye, FaPencilAlt, FaTrash, FaTimes, FaCar, FaSearch } from 'react-icons/fa';
...
const MOCK_VEHICLES: Vehicle[] = [
    { id: 1, marca: 'BMW', modelo: '320i', ano: 2022, placa: 'RTA-4G55', valor: 150000, status: 'Disponível' },
    { id: 2, marca: 'Fiat', modelo: 'Toro', ano: 2023, placa: 'XYZ-1234', valor: 145000, status: 'Disponível' },
    { id: 3, marca: 'Hyundai', modelo: 'HB20', ano: 2023, placa: 'JKL-4567', valor: 85000, status: 'Vendido' },
];
                ...
                <div className="flex items-center gap-4">
                    <div className="relative">
                        <input
                            ...
                            className="border border-gray-300 rounded-lg p-2 text-sm w-72 bg-white shadow-sm pl-10"
                        />
                        <FaSearch className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs" />
                    </div>
                    <select className="border border-gray-300 rounded-lg p-2 text-sm bg-white shadow-sm text-gray-700">
                        ...
                        {vehicles.length > 0 ? (
                            vehicles.map(veiculo => (
                                <tr key={veiculo.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="p-4 text-sm text-gray-800 font-semibold">{veiculo.valor.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</td>
                                    <td className="p-4 text-sm">{renderStatusBadge(veiculo.status)}</td>

                                    <td className="p-4 text-sm">
                                        <div className="flex items-center justify-center gap-2">
                                            <button title="Visualizar" className="p-2 rounded-full text-gray-400 hover:text-speedauto-primary hover:bg-gray-100 transition-all">
                                                <FaEye />
                                            </button>
                            ...
                            <tr>
                                <td colSpan={6}>
                                    <div className="text-center p-12">
                                        ...
                                        <h3 className="mt-4 text-lg font-semibold text-gray-700">Nenhum veículo cadastrado</h3>
                                        <p className="mt-1 text-sm text-gray-500">Comece adicionando seu primeiro veículo ao estoque.</p>
                                        <button
                                            onClick={() => openModal('add')}
                                        ...
                                        >
                                            <FaPlus /> Cadastrar Primeiro Veículo
                                        </button>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <div className="grid grid-cols-3 gap-5">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" name="marca" defaultValue={selectedVehicle?.marca}
                                                className="w-full border border-gray-300 rounded-lg p-2 text-sm transition-all
                                           focus:outline-none focus:border-speedauto-primary focus:ring-2 focus:ring-speedauto-primary/50"
                                    ...
                                    <div className="grid grid-cols-3 gap-5">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select name="status" defaultValue={selectedVehicle?.status ?? 'Disponível'}
                                                className="w-full border border-gray-300 rounded-lg p-2 text-sm bg-white transition-all
                                           focus:outline-none focus:border-speedauto-primary focus:ring-2 focus:ring-speedauto-primary/50" required>
