...
import { FaPlus, FaEye, FaPencilAlt, FaTrash, FaTimes, FaWallet, FaReceipt, FaCalendarCheck, FaSearch, FaInfoCircle, FaCalendarDay, FaDollarSign } from 'react-icons/fa';
...
const MOCK_SALES: Sale[] = [
    { id: 1001, cliente: 'Carlos Silva', veiculo: 'BMW 320i', valor: 150000.00, data: '2025-10-05', status: 'Concluída', observacoes: 'Financiamento aprovado Bradesco.' },
    { id: 1002, cliente: 'Ana Pereira', veiculo: 'Hyundai HB20', valor: 85500.00, data: '2025-10-02', status: 'Concluída', observacoes: 'Pagamento à vista via PIX.' },
    { id: 1003, cliente: 'Mariana Costa', veiculo: 'Jeep Renegade', valor: 120000.00, data: 'N/A', status: 'Em Andamento', observacoes: 'Aguardando aprovação de crédito.' },
    { id: 1004, cliente: 'Jorge Martins', veiculo: 'VW Nivus', valor: 115000.00, data: '2025-09-30', status: 'Cancelada', observacoes: 'Cliente desistiu por não aprovar o crédito.' },
    { id: 1005, cliente: 'Bruno Alves', veiculo: 'Ford Ka', valor: 55000.00, data: '2025-09-15', status: 'Concluída', observacoes: 'Primeiro carro.' },
];
...
export default function Vendas() {
    ...
    const [filterStatus, setFilterStatus] = useState<'Todos' | Sale['status']>('Todos');
        ...
        <>
            ...
            <div className="bg-white p-4 rounded-lg shadow border border-gray-200 mb-6 flex items-center gap-6">
                ...
                <select
                    ...
                    value={filterStatus}
                    onChange={(e) => setFilterStatus(e.target.value as 'Todos' | Sale['status'])}
                >
                        ...
                        {filteredSales.length > 0 ? (
                            filteredSales.map(sale => (
                                <tr key={sale.id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="p-4 text-sm text-gray-700">{formatDisplayDate(sale.data)}</td>
                            ...
                            <tr>
                                <td colSpan={7}>
                                    <div className="text-center p-12">
                                        ...
                                        <h3 className="mt-4 text-lg font-semibold text-gray-700">Nenhuma venda encontrada</h3>
                                        <p className="mt-1 text-sm text-gray-500">Ajuste os filtros ou o intervalo de datas para encontrar vendas.</p>
                                        <button
                                            onClick={() => { setSearchTerm(''); setFilterStatus('Todos'); setDataInicio(''); setDataFim(''); }}
                                ...
                                <div className="border border-gray-200 p-6 rounded-lg">
                                    ...
                                    <div className="grid grid-cols-3 gap-5">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="date" name="data" defaultValue={selectedSale?.data === 'N/A' ? '' : selectedSale?.data}
                                                className="w-full border border-gray-300 rounded-lg p-2 text-sm transition-all focus:outline-none focus:border-speedauto-primary focus:ring-2 focus:ring-speedauto-primary/50"
                                            />
                                        </div>
                ...
                <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50 p-4 transition-opacity duration-300">
                    <div className="bg-white rounded-lg shadow-2xl w-full max-w-xl animate-fade-in-up">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <DetailItem label="Data da Transação" value={formatDisplayDate(selectedSale.data)} />
